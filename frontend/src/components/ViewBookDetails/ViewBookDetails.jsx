 ...
 const role = useSelector((state) => state.auth.role);
  ...
  {Data && (
    ...
    {isLoggedIn === true && role === "admin" && (
        <div className='flex lex-col md:flex-row lg:flex-col items-center justify-between lg:justify-start mt-4 lg:mt-0  '>
      ...
      <h1 className="text-4xl text-zinc-300 font-semibold">by{Data.title}</h1>
